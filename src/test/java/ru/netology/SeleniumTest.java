...
public class SeleniumTest {
    ...
    void getTrueInputValidForm() {
        ...
        driver.findElement(By.cssSelector("[type='text']")).sendKeys("Николаев Николай");
    ...
    void getTrueInputValidFormMethod2() {
        ...
        form.findElement(By.cssSelector("[type='text']")).sendKeys("Николаев Николай");
    ...
    @Test
    void getTrueInputValidFormMethod3() {
        driver.get("http://localhost:9999");
        List<WebElement> webElements = driver.findElements(By.className("input__control"));
        webElements.get(0).sendKeys("Николаев Николай");
